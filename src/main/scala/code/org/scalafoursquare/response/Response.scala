...
case class VenueSpecials(count: Int, items: List[Special])
...
case class VenueCore(id: String, name: String, contact: VenueContact, location: VenueLocation,
                     categories: List[VenueCategoryCompact], verified: Boolean, stats: VenueStats, url: Option[String], menu: Menu, specials: VenueSpecials, hereNow: Option[VenueHereNow])

case class VenueMini(id: String, name: String, location: VenueLocation, category: VenueCategoryMini)
...
case class VenueDetail(
  ...
  def url = core.url
  def menu = core.menu
  def specials = core.specials
  def hereNow = core.hereNow
...
case class GeoCodeFeature(cc: Option[String], name: Option[String], displayName: Option[String])

// Geocode response
case class GeoCode(feature: GeoCodeFeature)

case class VenueDetailResponse(venue: VenueDetail)

case class VenueTrendingResponse(venues: List[VenueCompact])
case class VenueSearchResponse(venues: List[VenueCompact], geocode: GeoCode)

case class VenueSuggestCompletionResponse(minivenues: List[VenueMini])
...
case class VenueCategoryMini(id: Option[String], name: Option[String], pluralName: Option[String], shortName: Option[String],
                             icon: ImageMini)
...
case class ImageMini(prefix: Option[String], sizes: Option[List[Int]], name: Option[String])
...
// Menus
case class Menu(url: Option[String], mobileUrl: Option[String])
