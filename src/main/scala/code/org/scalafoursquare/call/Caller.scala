...
class UserlessApp(caller: Caller) extends App(caller) {
  ...
  def venueSearch(lat: Option[Double]=None, long: Option[Double]=None, near: Option[String]=None, llAcc: Option[Double]=None, alt: Option[Double]=None, altAcc: Option[Double]=None,
                  query: Option[String]=None, limit: Option[Int]=None, intent: Option[String]=None,
    ...
    new Request[VenueSearchResponse](this, "/venues/search",
      op("ll", {
        if (lat == None && long == None) {
          ...
          Some(lat.getOrElse(0.0) + "," + long.getOrElse(0.0))
        }
      }) ++
      op("near", near) ++
      op("llAcc", llAcc) ++
  ...
  def venueSuggestCompletion(lat: Double, long: Double, llAcc: Option[Double]=None, alt: Option[Double]=None, altAcc: Option[Double]=None,
                             query: Option[String]=None, limit: Option[Int]=None) =
    new Request[VenueSuggestCompletionResponse](this, "/venues/suggestcompletion",
      p("ll", lat + "," + long) ++
      op("llAcc", llAcc) ++
      op("alt", alt) ++
      op("altAcc", altAcc) ++
